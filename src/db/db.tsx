...
# Hello World!
\
For about 7 years, I held onto my domain name and email server without much thought of creating a working website. The motivation simply wasn't there.
\
I had a need for personal email but couldn't justify spending the time on building a website. I couldn't stomach using an 'off-the-shelf' solution eit! After all, I'm a software engineer, right?
\
...
It's imperative that the website remains easy to maintain and update. I want to ensure that I can effortlessly keep it current without extensive time investments.
\
**Cost-Efficiency**:\
Affordability is key. I'm steering clear of shared hosting options with clunky control panels and no SSH access. This project should be cheap! Dirt cheap!
\
**Cutting-Edge Technology**:\
I'm excited about the prospect of experimenting with new technologies while building this website. It's an opportunity for continuous learning, so I'm seeking a platform that embraces the cutting edge.
\
...
The solution should facilitate the straightforward deployment of small applications and enable their sharing through the website. I will likely utilize Docker and a hosting service that supports it, such as fly.io.
`,
    id: 1,
    updated: true,
    published: true,
