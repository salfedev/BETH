      ...
      {pages.map((page) => {
        return (
          <a
            id={page.path}
            href={page.path}
            class="hover:bg-slate-500 text-gray-400 text-sm py-1 px-1 rounded target:text-red-500"
          >
            {page.title}
          </a>
        );
